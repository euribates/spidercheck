...
"""
Módulo ``comun.results``
------------------------------------------------------------------------

Una implementación supersencilla de las monadas de resultado.  Se
...
``Success`` tienen un atributo ``valuea`` que les permite acceder al
...
Cualquier intento de aceceer a la propiedad ``value`` de un objeto de
...
tienen los métodos ``is_success()`` y ``is_failure()``, que devuelven
...
class Success:
    ...
    def error_message(self):
        """Atributo porhibido para las instancias de Success.
...
class Failure:
    ...
    def __repr__(self) -> str:
        ...
        return f'Failure({self.error_message!r}, code={self.code!r})'
    ...
    def __str__(self) -> str:
        ...
        return f'{self.code}: {self.error_message}'
